...
echo "$HOME/colcon_ws/src/STELLA_N1_PI_X4_PRO_ROS2_v2.0/stella_bringup/stella.rules"
sudo cp $HOME/colcon_ws/src/STELLA_N1_PI_X4_PRO_ROS2_v2.0/stella_bringup/stella.rules  /etc/udev/rules.d
echo " "
